...
//    APP_NAME = 'customize!project.name'
    APP_NAME = 'diskover-web' // Please do not edit this line! Managed by customize.sh
    ...
    stage('Functional Test') {
      ...
      steps {
        container('maven') {
          ...
          sh "mvn clean verify -Dtest.skip.unit=true -Dtest.skip.functional=false -Dtest.targetUrl=$PREVIEW_URL"
          echo 'Finished running functional tests.'
        }
      }
    }
